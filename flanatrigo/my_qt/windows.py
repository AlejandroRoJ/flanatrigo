...
class MainWindow(Salvable, QtWidgets.QMainWindow, metaclass=MixinMeta):
    def __init__(self, config: Config):
        ...
        self.button_close = TitleButton(constants.CLOSE_PATH, self, 1)
    ...
    def connect_signals(self, trigger_controller, picker_controller, afk_controller):
        self.central_widget.connect_signals(trigger_controller, picker_controller, afk_controller)
