...
class CentralWidget(QtWidgets.QWidget):
    ...
    def connect_signals(self, trigger_controller, picker_controller, afk_controller):
        ...
        self.line_hexadecimal.textChanged.connect(self.trigger_controller.on_line_hexadecimal_changed)
        self.line_trigger_activate_button.add_handlers(self.trigger_controller.on_press_activate, self.trigger_controller.on_release_activate, self.trigger_controller.on_double_press_activate)
        self.line_trigger_activate_button.textChanged.connect(lambda: self.trigger_controller.on_line_buttons_changed(self.line_trigger_activate_button))
        self.line_trigger_mode_button.add_handlers(self.trigger_controller.on_press_change_mode, double_press_handler=self.trigger_controller.on_press_change_mode)
        self.line_trigger_mode_button.textChanged.connect(lambda: self.trigger_controller.on_line_buttons_changed(self.line_trigger_mode_button))
        self.line_afk_activate_button.add_handlers(self.afk_controller.on_press_activate, double_press_handler=self.afk_controller.on_press_activate)
        self.line_afk_activate_button.textChanged.connect(lambda: self.afk_controller.on_line_buttons_changed(self.line_afk_activate_button))
        self.line_afk_press_button.textChanged.connect(lambda: self.afk_controller.on_line_buttons_changed(self.line_afk_press_button))

        self.button_color.clicked.connect(self.trigger_controller.open_color_dialog)

        self.check_trigger.clicked.connect(self.trigger_controller.on_check_trigger_changed)
        self.check_detector.stateChanged.connect(self.trigger_controller.on_check_detector_changed)
        self.check_picker.clicked.connect(self.picker_controller.on_check_picker_changed)
        self.check_afk.clicked.connect(self.afk_controller.on_check_afk_changed)
        ...
        self.spin_detector_size.editingFinished.connect(lambda: self.trigger_controller.on_spin_changed(self.spin_detector_size, self.slider_detector_size))
        self.spin_detector_size.editingFinished.connect(lambda: self.trigger_controller.open_crosshair_window())
        self.spin_detector_horizontal.editingFinished.connect(lambda: self.trigger_controller.on_spin_changed(self.spin_detector_horizontal, self.slider_detector_horizontal))
        self.spin_detector_horizontal.editingFinished.connect(lambda: self.trigger_controller.open_crosshair_window())
        self.spin_detector_vertical.editingFinished.connect(lambda: self.trigger_controller.on_spin_changed(self.spin_detector_vertical, self.slider_detector_vertical))
        self.spin_detector_vertical.editingFinished.connect(lambda: self.trigger_controller.open_crosshair_window())
        self.spin_tolerance.editingFinished.connect(lambda: self.trigger_controller.on_spin_changed(self.spin_tolerance, self.slider_tolerance))
        self.spin_rage_immobility.editingFinished.connect(lambda: self.trigger_controller.on_spin_changed(self.spin_rage_immobility, self.slider_rage_immobility))
        self.spin_rage_tolerance.editingFinished.connect(lambda: self.trigger_controller.on_spin_changed(self.spin_rage_tolerance, self.slider_rage_tolerance))
        self.spin_picker_delay.editingFinished.connect(lambda: self.picker_controller.on_spin_changed(self.spin_picker_delay, self.slider_picker_delay))
        self.spin_picker_duration.editingFinished.connect(lambda: self.picker_controller.on_spin_changed(self.spin_picker_duration, self.slider_picker_duration))
        self.spin_picker_steps.editingFinished.connect(lambda: self.picker_controller.on_spin_changed(self.spin_picker_steps, self.slider_picker_steps))
        self.spin_afk_interval.editingFinished.connect(lambda: self.afk_controller.on_spin_changed(self.spin_afk_interval, self.slider_afk_interval))

        self.list_agents.currentItemChanged.connect(self.picker_controller.on_selected_item)
