...
TOLERANCE = 70
RAGE_MODE = False
RAGE_IMMOBILITY = 0.25
RAGE_TOLERANCE = 10
TRIGGER_ACTIVATE_BUTTON = 'mouse_x2'
...
CENTRAL_WIDGET_DOUBLE_BUTTON_WAITING_SECONDS = 0.3
CENTRAL_WIDGET_MOUSE_HOTKEY_WAITING_SECONDS = 0.05
CLICK_DELAY = 0.02
